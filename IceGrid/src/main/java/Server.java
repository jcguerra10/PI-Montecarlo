...
public class Server
{
    public static void main(String[] args)
    {
        ...
        try(com.zeroc.Ice.Communicator communicator = com.zeroc.Ice.Util.initialize(args, extraArgs))
        {
            ...
            {
//                com.zeroc.Ice.ObjectAdapter adapter = communicator.createObjectAdapter("Montecarlo");
//                com.zeroc.Ice.Properties properties = communicator.getProperties();
//                com.zeroc.Ice.Identity id = com.zeroc.Ice.Util.stringToIdentity(properties.getProperty("Identity"));
//                adapter.add(new MontecarloI());
//                adapter.activate();
//
//                communicator.waitForShutdown();
                ObjectAdapter adapter = communicator.createObjectAdapter("MontecarloAdapter");
                adapter.add(new MontecarloFactoryI(), stringToIdentity("MontecarloFactory"));
                adapter.activate();
                communicator.waitForShutdown();
